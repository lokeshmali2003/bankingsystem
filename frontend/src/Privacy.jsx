          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Banking System ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy 
                explains how we collect, use, disclose, and safeguard your information when you use our banking services 
                and website.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Email: privacy@bankingsystem.com<br />
